...
//added a second button and created 2 new functions to start/stop tracking
...
document.getElementById("btnToggle").addEventListener("click", startTracking);
document.getElementById("btnToggle2").addEventListener("click", stopTracking);
document.getElementById("myBox").addEventListener("mousemove", updateMousePosition);

//added another div to track mouse position within that element only. 